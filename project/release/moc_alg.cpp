...
**
** Created: Fri 28. Mar 20:38:24 2014
...
static const char qt_meta_stringdata_Alg[] = {
    "Alg\0\0x1,y1,x2,y2,iterations,inf,c_re,c_im\0"
    "next(double,double,double,double,int,double,double,double)\0"
};
...
int Alg::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: next((*reinterpret_cast< double(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2])),(*reinterpret_cast< double(*)>(_a[3])),(*reinterpret_cast< double(*)>(_a[4])),(*reinterpret_cast< int(*)>(_a[5])),(*reinterpret_cast< double(*)>(_a[6])),(*reinterpret_cast< double(*)>(_a[7])),(*reinterpret_cast< double(*)>(_a[8]))); break;
        default: ;
        }
        _id -= 1;
    }
